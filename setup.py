...
class CMakeBuild(build_ext):
    def build_extension(self, ext):
        ...
        cmake_args = [
            ...
            "-DQUSAT_VERSION_INFO={}".format(version),
...
setup(
    ...
    python_requires='>=3.6',
    license="MIT",
    url="https://github.com/cda-tum/qusat",
    ext_modules=[CMakeExtension('pyqusat', namespace='mqt.qusat.')],
    ...
    project_urls={
        'Source': 'https://github.com/cda-tum/qusat',
        'Tracker': 'https://github.com/cda-tum/qusat/issues'
    }
)
